function CartItem({ item, onIncrease, onDecrease, onRemove }) {
  ...
  return (
    <div className="grid gap-4 rounded-lg border border-orange-100 bg-white p-4 sm:grid-cols-[120px_1fr_auto] sm:items-center">
      <img
      ...
      <div>
        ...
        <div className="mt-3 flex items-center gap-2">
          ...
          <button
            ...
            className="ml-2 rounded-md px-3 py-2 text-sm font-bold text-red-700 hover:bg-red-50"
          >
            Remover
          </button>
        </div>
